...
beatsviz.controller.bcnRT = function(options) {
  ...
  $(document).ready(function() {
    ...
    var injectString = ['<div id="contenedorTodo" class="wrapper">',
      '<header>',
      ...
      '</div>',
      '<div id="instagram-modal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">',
